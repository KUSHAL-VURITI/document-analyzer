...
import { Sparkles, List, MessagesSquare, FileText, ArrowRight, Plus, Calendar } from "lucide-react";
...
export function AiPanel() {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="px-3.5 sm:px-5 py-2.5 sm:py-3.5 border-b border-[var(--border)] shrink-0 flex justify-between items-center gap-3">
        <div className="flex items-center gap-2.5 w-full min-w-0">
          ...
          <div className="flex flex-col min-w-0 flex-1">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <h2 className="text-xs sm:text-sm font-medium truncate text-foreground" title={file?.name}>
      ...
      <Tabs defaultValue="summary" className="flex-1 min-h-0 flex flex-col h-full overflow-hidden">
        ...
        <div className="px-3 sm:px-5 shrink-0 border-b border-[var(--border)]">
        ...
        {/* Summary Tab */}
        <TabsContent value="summary" className="m-0 p-3.5 sm:p-5 flex-1 min-h-0 overflow-y-auto custom-scrollbar space-y-4 focus-visible:outline-none focus-visible:ring-0 animate-in fade-in duration-200">
          ...
          {dates.length > 0 && (
            <div className="flex items-center gap-2 px-3 py-2 bg-card border border-[var(--border)] rounded-lg text-xs shadow-xs">
          ...
          {/* Summary text */}
          <div className="bg-card border border-[var(--border)] rounded-xl p-4 sm:p-5 text-sm leading-relaxed text-foreground [&>p]:mb-3 last:[&>p]:mb-0 [&>ul]:list-disc [&>ul]:pl-5 [&>ul]:mb-3 [&>ol]:list-decimal [&>ol]:pl-5 [&>ol]:mb-3 [&_strong]:font-semibold shadow-xs hover:border-[var(--annotation)]/20 transition-all duration-300">
        ...
        {/* Key Points tab */}
        <TabsContent value="keypoints" className="m-0 p-3.5 sm:p-5 flex-1 min-h-0 overflow-y-auto custom-scrollbar space-y-3 focus-visible:outline-none focus-visible:ring-0 animate-in fade-in duration-200">
        ...
        {/* Chat tab */}
        <TabsContent value="ask" className="m-0 p-3 sm:p-4 flex-1 min-h-0 overflow-hidden flex flex-col h-full focus-visible:outline-none focus-visible:ring-0 animate-in fade-in duration-200">
          <ChatTab />
        </TabsContent>
      </Tabs>
    </div>
